...
<!-- Add the new fields based on your requirements -->
<div class="mb-3">
    <label for="modalTenantSocieteId" class="form-label">Tenant Société ID:</label>
    <input type="text" class="form-control" id="modalTenantSocieteId" name="tenant_societe_id" value="{{ old('tenant_societe_id') }}">
</div>

<div class="mb-3">
    <label for="modalClientSocieteId" class="form-label">Client Société ID:</label>
    <input type="text" class="form-control" id="modalClientSocieteId" name="ClientSociéteId" value="{{ old('ClientSociéteId') }}">
</div>
...
<!-- Continue adding fields as needed -->
                        ...
                        <div class="mb-3">
                            <label for="modalDevise" class="form-label">Devise:</label>
                            <input type="text" class="form-control" id="modalDevise" name="Devise" value="{{ old('Devise') }}">
                        </div>

                        <div class="mb-3">
                            <label for="modalReferenceFacture" class="form-label">Référence Facture:</label>
                            <input type="text" class="form-control" id="modalReferenceFacture" name="RéferenceFacture" value="{{ old('RéferenceFacture') }}">
                        </div>
    ...
    <table class="table" id="factureTable">
        <thead>
            <tr>
                ...
                <th>Facture ID</th>
                <th>Devis ID</th>
                <th>Tenant Société ID</th>
                <th>Client Société ID</th>
        ...
        <tbody>
            @foreach ($factures as $facture)
                <tr>
                    ...
                    <td>{{ $facture->TenantSociétéId }}</td>
                    <td>{{ $facture->ClientSociéteId }}</td>
                    ...
                    <td>{{ $facture->RéferenceFacture }}</td>
                    <td>
